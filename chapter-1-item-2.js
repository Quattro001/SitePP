    ...
    const tasks = [
      {
        ...
        question: "Реши неравенство х+8/2 ≤ 5-х/3 и выбери правильный ответ",
        answers: ["-11", "5*x ≤ - 14", "x ≤ -14/5."],
        correct: 2,
        multiple: false
      },
      {
        ...
        chapter: 1,
        title: "Свежая трава",
        question: "Из свежей травы изготовили 6,16 т. корма, что составило 77% свежей травы. Определить кол-во использованной свежей травы. Найди количество корма, которое можно изготовить из 2,4 т свежей травы.",
        answers: ["18 тонн свежей травы, 11238кг корма", "8 тонн свежей травы, 1848кг корма", "9 тонн свежей травы, 12342кг корма", "3 тонн свежей травы, 1848кг корма"],
        correct: 1,
        multiple: false
      },
    ];
